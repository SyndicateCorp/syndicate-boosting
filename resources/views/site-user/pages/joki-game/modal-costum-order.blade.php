                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control rounded-3" id="customer_contact"
                                ...
                                placeholder="Contoh: 081234567890 | Gunakan nomor yang AKTIF agar kami bisa menguhungi anda"
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="email" class="form-control rounded-3" id="customer_email"
                                ...
                                placeholder="Contoh: budi@gmail.com | Gunakan email yang AKTIF agar mendapatkan notifikasi nota pembayaran"
                                maxlength="255">
                        </div>
                        <!-- Username/ID Akun -->
                        <div class="col-md-6">

                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control rounded-3" id="customer_contact"
                                ...
                                placeholder="081234567890 | Gunakan nomor yang AKTIF agar kami bisa menguhungi anda"
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="email" class="form-control rounded-3" id="customer_email"
                                ...
                                placeholder="budi@gmail.com | Gunakan email yang AKTIF agar mendapatkan notifikasi nota pembayaran"
                                maxlength="255">
                            <div class="invalid-feedback"></div>
                        </div>
                        <!-- Username/ID Akun -->
